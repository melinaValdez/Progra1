...
public class Pedidos extends javax.swing.JFrame {
    ...
    private void tablaResultadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaResultadosMouseClicked
        DefaultTableModel modelo = (DefaultTableModel)tablaResultados.getModel();
         ...
         String dispo = (String)modelo.getValueAt(indice, 3);
         String pre = (String) modelo.getValueAt(indice, 5);
         
         int disponibles = Integer.parseInt(dispo);
         int precio = Integer.parseInt(pre);
         
         String descripcion = (String)modelo.getValueAt(indice, 2);
              
         Libro libro = new Libro(nombre, precio, disponibles, tema);
